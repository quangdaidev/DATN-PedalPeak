        ...
        <header className="py-6">
            <nav className="flex flex-row justify-between items-center relative">
                ...
                <ul  className=" basis-5/12 flex items-center justify-center gap-8 uppercase text-sm text-gray-500 font-medium">
                    ...
                    <li className="ct-top-menu-item">
                        <Link href="/sanpham" className="">Sản phẩm</Link>
                    </li>
                    <li className="ct-top-menu-item">
                        <Link href="" className="">Bài viết</Link>
                    </li>
                    <li className="ct-top-menu-item">
                        <Link href="" className="">Về chúng tôi</Link>
                    </li>
                    <li className="ct-top-menu-item">
                        <Link href="" className="">Liên hệ</Link>
                    </li>
                </ul>      
                ...
                <ul className="basis-3/12 flex justify-end gap-8 items-center ml-16 text-sm text-gray-500 font-medium">
                    <li className="ct-top-menu-item relative group">  
                        <div>
                            ...
                            <ul className="absolute top-7 left-0 hidden w-48 bg-white shadow-lg group-hover:block">
                                <li className="block p-2 text-gray-500 hover:text-white hover:bg-gray-400"><Link href="/dang-ky">Đăng ký</Link></li>
                                <li className="block p-2 text-gray-500 hover:text-white hover:bg-gray-400"><Link href="/dang-nhap">Đăng nhập</Link></li>
                            </ul>
                        </div>
                       {/* {user? (<div>
                            <UserIcon className="ct-icon" />
                            ...
                            <ul className="absolute top-7 left-0 hidden w-40 bg-white shadow-lg group-hover:block">
                                ...
                                <li className="block p-2 text-gray-500 hover:text-white hover:bg-gray-400"><Link href="/info">Thông tin tài khoản</Link></li>
                            </ul>
                        </div>) :
                    ...
                    <li className="ct-top-menu-item">
                        <button type="button" onClick={() => setOpen(true)} className="items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="ct-icon">
